Translate selected word or phrase over translate.yandex.ru from any lang to Russian (or from Russian to English) - result in context menu (right click), or if translated text more than 75 symbols - in popup. Minimum and fast - without hotkeys and option screen. Unofficial extension - works using official API.
